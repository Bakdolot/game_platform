...
class Battle(models.Model):
    ...
    views = models.ManyToManyField(settings.AUTH_USER_MODEL, verbose_name=_('Просмотры'), related_name='views')
    reposts = models.ManyToManyField(settings.AUTH_USER_MODEL, verbose_name=_('Репосты'), related_name='reposts')
...
class BattleMembers(models.Model):
    ...
    player_2 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 2'), on_delete=models.SET_NULL, null=True, related_name='battle_member_player_2')
    player_3 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 3'), on_delete=models.SET_NULL, null=True, related_name='battle_member_player_3')
    player_4 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 4'), on_delete=models.SET_NULL, null=True, related_name='battle_member_player_4')
    player_5 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 5'), on_delete=models.SET_NULL, null=True, related_name='battle_member_player_5')
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Заказчик'), on_delete=models.CASCADE)
...
class BattleResponse(models.Model):
    ...
    player_2 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 2'), on_delete=models.SET_NULL, null=True, related_name='battle_response_player_2')
    player_3 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 3'), on_delete=models.SET_NULL, null=True, related_name='battle_response_player_3')
    player_5 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 5'), on_delete=models.SET_NULL, null=True, related_name='battle_response_player_5')
    player_4 = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Игрок 4'), on_delete=models.SET_NULL, null=True, related_name='battle_response_player_4')
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Заказчик'), on_delete=models.CASCADE)
